...
public:
	...
	vector_block(int n = 1, double r = 0);
...
public:
	...
	//friend matrix trans(matrix& A);         //транспонирование

	//const  operator[](int i) const;   //возвращает строку или столбец в виде новой матрицы
	...
	//vector_block operator*(matrix_block m, vector_block v);
